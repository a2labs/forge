...
var postal = require( "postal" ),
    ...
    runner = {
        ...
        rabbitConnect: function( settings ) {
            ...
            conn.on('ready', function() {
                ...
                conn.queue( settings.queue, function(queue) {
                    ...
                    postal.channel( "forge", "log" ).publish( {data: "[forge] RabbitMQ connection bound to " + settings.key } );
        ...
        startDaemon: function( app, parent_process ) {
            ...
            postal.channel( "forge", "daemon" ).publish( { data: "[forge] Starting forge in daemon mode" } );
        ...
        savePid: function( pid, app ) {
            ...
            fs.writeFile( file, pid, 'utf-8', function(err) {
                if ( err ) {
                    postal.channel( "forge", "error" ).publish( {data: "Could not save PID file" } );
                }
            });
